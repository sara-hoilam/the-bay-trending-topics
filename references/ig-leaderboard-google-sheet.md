...
| date | handle | display_name | followers | followers_growth_pct_7d | captured_at |
...
| `followers_growth_pct_7d` | **Local JSON history** during capture; **Google Sheet history** overrides during sync when a reference row exists |
